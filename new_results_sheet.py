...
for MIL_model in os.listdir("hrd_prediction/results"):
    if MIL_model.startswith("real") or MIL_model.startswith("5") or MIL_model.startswith("10") or MIL_model.startswith("25"):
...
stat_df.to_excel("hrd_prediction/results/cluster_new_result_stats.xlsx")
