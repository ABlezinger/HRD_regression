...
import numpy as np
import pipeline_utils.stain_utils as ut
...
class Normalizer(object):
    ...
    def fit(self, target):
        if (not os.path.exists('custom_WSI_pipeline/pipeline_utils/stain_matrix_target.npy') and 
        not os.path.exists('custom_WSI_pipeline/pipeline_utils/target_concentrations.npy')):
            ...
            np.save('custom_WSI_pipeline/pipeline_utils/stain_matrix_target.npy', self.stain_matrix_target)
            np.save('custom_WSI_pipeline/pipeline_utils/target_concentrations.npy', self.target_concentrations)
        else:
            self.stain_matrix_target = np.load('custom_WSI_pipeline/pipeline_utils/stain_matrix_target.npy')
            self.target_concentrations = np.load('custom_WSI_pipeline/pipeline_utils/target_concentrations.npy')
