...
# EXTRACTION_MODELS=("UNI" "RetCCL" "GPFM" "CONCH" "Virchow_2")
# EXTRACTION_MODELS=("UNI" "RetCCL" "CONCH" "Virchow_2")
...
# BAGSIZES=(50 100 200 400 1400 1600 2000 3000 4000)
# BAGSIZES=(600 800 1000 1200)
BAGSIZES=(2000)
# BAGSIZES=(0)
...
do
    ...
    do
        sbatch --job-name="r_${MODEL}_${BAGSIZE}" multi_crossval.sh --extraction_model "$MODEL" --bag_size "$BAGSIZE"
    done
done    